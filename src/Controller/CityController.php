...
final class CityController extends AbstractController
{
    ...
    #[Route('/editor/new', name: 'app_city_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success','La Ville a bien était ajouter');
    ...
    #[Route('/editor/{id}', name: 'app_city_show', methods: ['GET'])]
    ...
    #[Route('/editor/{id}/edit', name: 'app_city_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, City $city, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success','La Villea était modifier');
            return $this->redirectToRoute('app_city_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/editor/{id}', name: 'app_city_delete', methods: ['POST'])]
